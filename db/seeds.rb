...
CodingClass.all.find_each do |coding_class|
  Trimester.all.find_each do |trimester|
...
Trimester.where("start_date < '2025-05-01'").find_each do |trimester|
...
Rails.logger.debug 'End data seeding'
