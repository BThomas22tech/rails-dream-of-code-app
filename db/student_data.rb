...
Rails.logger.debug 'Populating student and mentor data...'

# Create enrollments for past and current trimesters
Trimester.where("start_date < '2025-05-01'").find_each do |trimesters|
...
Rails.logger.debug 'Finished populating student and mentor data'
